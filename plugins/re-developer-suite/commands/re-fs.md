...
- Dựng model 7 sheet theo spec fs-structure trong references của skill `re-inv-feasibility-study`, xuất `.xlsx` vào `deals/<deal-id>/analysis/`.
- Tie-out, chạy `re-inv-verification-rules`, rồi cập nhật dossier.
