...
- Làm theo skill `re-project-design`; mọi tính toán chỉ tiêu quy hoạch chạy đúng quy trình 9 bước của `design-planning` với calc engine trong references của skill đó.
...
- Chỉ phát hành kết luận design/planning; khả năng phê duyệt pháp lý thuộc licensing-expert, FS tài chính thuộc RE-Investment-Finance.
