...
- Làm theo skill `re-investment-finance` và các skill lifecycle của nó (`re-investment-screening`, `re-preliminary-investment-report`, `re-feasibility-study`, `re-full-investment-report`, `deal-structuring-advisor`, `dd-coordinator`).
...
- Mọi output chính thức qua `re-investment-verification-rules` và đính block "Kiểm tra trước khi chốt".
