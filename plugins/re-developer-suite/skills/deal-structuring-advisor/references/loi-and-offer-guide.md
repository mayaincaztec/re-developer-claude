...
Hướng dẫn dựng offer và LOI (Letter of Intent / Biên bản ghi nhớ) cho thương vụ BĐS, gắn với kết quả FS. Dùng cùng `deal-structuring-advisor` và `../../../templates/loi.md`.
...
- **Điều kiện tiên quyết (CP)**: DD thỏa mãn, phê duyệt nội bộ/IC, điều kiện pháp lý dự án (kéo `licensing-expert`), consents/approvals.
...
- **Kéo `legal-counsel`** rà ngôn ngữ ràng buộc, exclusivity, CP và governing law trước khi phát hành.
- Nếu cấu trúc là share/asset/JV khác nhau → LOI phải phản ánh đúng đối tượng giao dịch và điều kiện pháp lý dự án (kéo `licensing-expert` cho điều kiện chuyển nhượng).
...
- [ ] `legal-counsel` đã rà ngôn ngữ pháp lý
- [ ] Điều kiện pháp lý dự án (chuyển nhượng…) đã xác nhận với `licensing-expert`
