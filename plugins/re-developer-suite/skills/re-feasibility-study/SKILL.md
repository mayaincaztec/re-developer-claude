...
### Bước 5 — QC
Qua `re-investment-verification-rules`: không bịa số, phân biệt calculated/assumption/external, base/upside/downside có trong sensitivity, what-must-be-true rõ.
