...
> Source of truth cho **cấu trúc** vault dữ liệu market research. Data format chi tiết (frontmatter, template) do `_config/` trong vault quyết định; SOP do skill `re-rnd` quyết định.
...
<vault_root>/                      # vault Obsidian, khai báo trong re-workspace.yaml
  _config/
    ...
    AGENT_SKILL.md                 # con trỏ về skill re-rnd trong plugin
  projects/
...
| SOP / protocols | skill `re-rnd` | `AGENT_SKILL.md` chỉ là con trỏ, không chứa SOP |
