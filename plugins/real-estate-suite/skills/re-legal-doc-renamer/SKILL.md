...
- Skill này không thay thế `re-legal-licensing` hoặc `re-legal-counsel`; nó chỉ chuẩn bị đầu vào tài liệu hoặc trả lời bài toán naming / filing.
