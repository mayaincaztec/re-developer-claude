...
Kỹ thuật đọc cụ thể (7 nguyên tắc + quy trình 7 vòng — đối kháng, đại từ, định nghĩa, 4 yếu tố nghĩa vụ, mơ hồ, im lặng/mặc định luật, viết cho tài phán): `references/contract-reading-review-method.md`.
...
Riêng **SPA/SSA/SHA M&A** (Reps & Warranties, Indemnification, MAC, Earn-out, Escrow, Drag/Tag-along, ROFR/ROFO, Non-compete sau M&A, Conditions Precedent, quan hệ SHA–Điều lệ), dùng bộ tài liệu M&A theo từng lens:
- `references/ma-traps-catalog.md` — catalog 50 bẫy điều khoản (cơ chế gây hại + **bẫy cộng hưởng** đọc chéo định nghĩa) cho **review/redline**;
- `references/ma-negotiation-briefs.md` — 50 brief đàm phán (lập luận both-sides + **fair middle ground** thị trường) cho **negotiation/prep**;
- `references/ma-clause-playbook-vn.md` — đối chiếu **căn cứ pháp lý Việt Nam** (khái niệm nào không ánh xạ BLDS, điều luật nào bắt buộc dẫn) trước khi kết luận có hiệu lực/thực thi tại VN;
- `references/ma-document-guides.md` — chuẩn thị trường US/ABA/SRS Acquiom cho deal points.

**Lưu ý:** catalog trap và negotiation briefs là **jurisdiction-neutral (thông lệ quốc tế)** — luôn overlay luật VN qua `ma-clause-playbook-vn.md` + verify điều luật qua MCP `legal` trước khi kết luận.
...
- `references/ma-document-guides.md` — hướng dẫn soạn/review theo loại tài liệu (NDA/LOI/Term Sheet/SPA/SHA/Framework) + chuẩn thị trường US/ABA/SRS Acquiom cho deal points nâng cao
...
7. Giữ nguyên khái niệm Anh-Mỹ (warranty, indemnification, escrow, MAC...) trong SPA/SHA dịch từ tiếng Anh mà không đối chiếu ánh xạ BLDS/LDN — xem `references/ma-clause-playbook-vn.md` trước khi kết luận điều khoản có hiệu lực/thực thi được tại Việt Nam.
