...
Riêng **SPA/SHA M&A** (Reps & Warranties, Indemnification, MAC, Earn-out, Escrow, Drag/Tag-along, ROFR/ROFO, Non-compete sau M&A, Conditions Precedent, quan hệ SHA–Điều lệ): dùng `references/ma-clause-playbook-vn.md` để đối chiếu điều khoản kiểu Anh-Mỹ với **căn cứ pháp lý Việt Nam** (khái niệm nào không ánh xạ trực tiếp BLDS, điều luật nào bắt buộc dẫn) trước khi kết luận có hiệu lực/thực thi được tại VN — dùng cùng `references/ma-document-guides.md` (chuẩn thị trường US/ABA) để biết mức đàm phán thị trường.
