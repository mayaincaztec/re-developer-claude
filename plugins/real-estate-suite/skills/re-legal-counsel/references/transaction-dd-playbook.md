...
4. **Phát biểu từng finding** theo format bắt buộc; **không tự lấp khoảng trống** bằng suy đoán; văn bản luật viện dẫn phải kiểm chứng hiệu lực qua `legal` (`../../../references/legal-lookup-protocol.md`) hoặc gắn caveat "chưa kiểm chứng".
...
Kiểm chứng luật: [legal: tình trạng + ngày | hoặc "chưa kiểm chứng"]
...
- **Kiểm chứng nguồn không thương lượng:** mọi viện dẫn luật phải có dấu legal hoặc caveat; **không tự lấp** bằng web/model knowledge khi hồ sơ mỏng — dừng và hỏi.
