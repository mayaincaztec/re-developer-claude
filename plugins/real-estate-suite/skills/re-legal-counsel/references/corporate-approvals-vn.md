# Corporate Approvals (VN) — văn kiện phê duyệt nội bộ cho giao dịch
...
| Loại hình | Cơ quan quyết định | Văn kiện |
|---|---|---|
| Công ty cổ phần | ĐHĐCĐ / HĐQT (theo thẩm quyền) | Biên bản họp + Nghị quyết ĐHĐCĐ; Nghị quyết HĐQT; nghị quyết bằng **lấy ý kiến bằng văn bản** |
| TNHH 2 thành viên trở lên | Hội đồng thành viên | Biên bản họp + Nghị quyết HĐTV |
| TNHH một thành viên | Chủ sở hữu / HĐTV / Chủ tịch | Quyết định của chủ sở hữu; Nghị quyết HĐTV |

## Khi nào cần phê duyệt nội bộ (rà trước khi giao dịch)

Phân loại hành động (theo logic của written-consent):
...
## Cấu trúc văn kiện chuẩn

**Nghị quyết / Quyết định** (HĐQT / ĐHĐCĐ-bằng văn bản / chủ sở hữu):
```
[TÊN CÔNG TY] — NGHỊ QUYẾT/QUYẾT ĐỊNH số .../...
Cơ quan ban hành · Ngày · Hình thức (họp / lấy ý kiến bằng văn bản)

CĂN CỨ:
- Luật Doanh nghiệp 2020 và văn bản hướng dẫn (đã kiểm chứng hiệu lực);
- Điều lệ công ty [điều khoản];
- [hồ sơ giao dịch liên quan].

XÉT:
- [bối cảnh, tờ trình, đề xuất giao dịch].

QUYẾT NGHỊ:
Điều 1. [Hành động cụ thể — chấp thuận giao dịch X, giá/giá trị, đối tác, tài sản].
Điều 2. [Ủy quyền người đại diện ký kết & thực hiện; phạm vi ủy quyền].
Điều 3. [Hiệu lực, tổ chức thực hiện].

Tỷ lệ thông qua: [.../...] · Chữ ký người có thẩm quyền.
```

**Biên bản họp** (ĐHĐCĐ / HĐQT / HĐTV) — khi quyết nghị bằng hình thức họp:
```
Tiêu đề · công ty · ngày · địa điểm/hình thức (trực tiếp/trực tuyến)
Khai mạc: chủ tọa, thư ký, thời điểm
Điều kiện tiến hành họp: xác nhận đủ điều kiện (tỷ lệ dự họp theo LDN/điều lệ) — THIẾU thì DỪNG, cờ outside counsel
Thành phần dự họp: có mặt / vắng / ủy quyền
Nội dung & thảo luận theo từng nội dung
Biểu quyết: tỷ lệ tán thành/không/trắng cho từng nội dung; ghi rõ bên có liên quan KHÔNG biểu quyết
Nghị quyết thông qua
Bế mạc · chữ ký chủ tọa + thư ký
```

## Quy tắc & cổng chặn (gates)

1. **Đọc điều lệ trước** — thẩm quyền và tỷ lệ trong điều lệ kiểm soát; không soạn theo "mẫu chung" khi chưa có điều lệ/tiền lệ.
