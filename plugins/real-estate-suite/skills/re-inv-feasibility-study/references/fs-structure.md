...
- **Đất & chỉ tiêu**: diện tích đất, mật độ XD, FAR, GFA, NSA, efficiency% (kéo `re-project-design-planning`).
- **Product mix**: theo dòng sản phẩm — số sản phẩm, diện tích bình quân, NSA bán được.
- **Giá bán**: đơn giá bán/m² hoặc /sản phẩm theo dòng (kéo `re-rnd`); escalation %/năm.
